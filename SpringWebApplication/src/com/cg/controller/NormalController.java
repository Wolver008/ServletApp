...
public class NormalController {
	...
	public ModelAndView getHome(){
		...
		//String data1="IOC , DI";
		String data2="welocme to My Home Page!!!";
...
/*	@RequestMapping(value="register",method=RequestMethod.GET)
	...
	*/
	...
	public String getloginPage(Model m){
		Customer cust=new Customer();
		m.addAttribute("loginObj",cust);
		return "login";
	}
	
	@RequestMapping("logincust")
	public String logincust(Model m,@ModelAttribute("loginObj") Customer customer){
		
		m.addAttribute("lObj",customer);
